...
path = "abfss://supplychain-ibp@cdodevadls2.dfs.core.windows.net/silver/iberia/ibp-poc/shipment-actuals"
...
#PK Duplicate check
dup_df = silver_df.groupBy("PROD_CD", "CUST_GRP", "LOC", "STRTDT").count().filter("count > 1")
display(dup_df)
