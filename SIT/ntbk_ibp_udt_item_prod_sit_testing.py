...
"""
This notebook is for performing the SIT test cases of UDT item product mapping
"""
...
#Defining the source and bronze path for UDT item product mapping
source_path = "abfss://supplychain-ibp@cdodevadls2.dfs.core.windows.net/archive/iberia/europe-dl/ibp/udt-item-prod-mapping/datepart=2021-10-22/"
bronze_path = "abfss://supplychain-ibp@cdodevadls2.dfs.core.windows.net/bronze/iberia/europe-dl/ibp/udt-item-prod-mapping/"
...
#Source and Bronze Layer Count Validation for UDT item product mapping
print("Source Layer Count is "+str(source_df.count()))
print("Bronze Layer Count is "+str(bronze_df.count()))

# COMMAND ----------

#Source and Bronze layer column validation for UDT item product mapping
...
#Source to Bronze Layer - Minus check for source file vs Bronze layer and vice versa for UDT item product mapping
